...
public class P2PsychicPokemon extends AbstractPsychicPokemon implements IP2Pokemon {

    /**
     * Constructor for a phase-two psychic-type pokemon.
     ...
     */
    public P2PsychicPokemon(int id, String name, int hp, ArrayList<IAbility> abilityList, int evolvedID, HashMap<String, Integer> energyList, Trainer trainer){
    ...
    @Override
    public boolean equals(Object obj) {return obj instanceof P2PsychicPokemon && super.equals(obj);}
