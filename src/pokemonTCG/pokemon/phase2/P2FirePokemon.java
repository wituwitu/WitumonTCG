...
public class P2FirePokemon extends AbstractFirePokemon implements IP2Pokemon {

    /**
     * Constructor for a phase-two fire-type pokemon.
     ...
     */
    public P2FirePokemon(int id, String name, int hp, ArrayList<IAbility> abilityList, int evolvedID, HashMap<String, Integer> energyList, Trainer trainer){
    ...
    @Override
    public boolean equals(Object obj) {return obj instanceof P2FirePokemon && super.equals(obj);}
