...
public class P2GrassPokemon extends AbstractGrassPokemon implements IP2Pokemon {

    /**
     * Constructor for a phase-two grass-type pokemon.
     ...
     */
    public P2GrassPokemon(int id, String name, int hp, ArrayList<IAbility> abilityList, int evolvedID, HashMap<String, Integer> energyList, Trainer trainer){
    ...
    @Override
    public boolean equals(Object obj) {return obj instanceof P2GrassPokemon && super.equals(obj);}
