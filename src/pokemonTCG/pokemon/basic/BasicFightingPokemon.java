...
public class BasicFightingPokemon extends AbstractFightingPokemon implements IBasicPokemon {
     ...
     */
    public BasicFightingPokemon(int id, String name, int hp, ArrayList<IAbility> abilityList, Trainer trainer){
    ...
    @Override
    public P1FightingPokemon evolve(int id, String name, int hp, ArrayList<IAbility> abilityList){
        return new P1FightingPokemon(id, name, hp, abilityList, this.getID(), this.getEnergyList(), this.getTrainer());
    }
    ...
    @Override
    public boolean equals(Object obj) {return obj instanceof BasicFightingPokemon && super.equals(obj);}
